...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '6416351316:AAFkgIzruqlfxke4Wl-4K-2L558go8X-UdY'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://8e9b-115-164-119-134.ngrok-free.app/telegram-webhook'),
            'commands' => [
                HelpCommand::class,
                ProductCommand::class, // Add your custom command here
            ],
