...
class VendorServiceDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $editBtn = "<a href='".route('vendor.service.edit', $query->id)."' class='btn btn-primary'><i class='far fa-edit'></i></a>";
            $deleteBtn = "<a href='".route('vendor.service.destroy', $query->id)."' class='btn btn-danger delete-item' ><i class='far fa-trash-alt'></i></a>";
    ...
    {
        return $this->builder()
                    ->setTableId('vendorservice-table')
    ...
    {
        return 'VendorService_' . date('YmdHis');
    }
}
