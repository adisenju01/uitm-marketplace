...
class ProductListingAppItemDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $deleteBtn = "<a href='".route('admin.product-listing-app.destory', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
     ...
     */
    public function query(ProductListingAppItem $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('productlistingappitem-table')
    ...
    {
        return 'ProductListingAppItem_' . date('YmdHis');
    }
}
